...
- [x] Linked from skip-noisy-endpoints
...
Cookbook page for log sampling and rate limiting with middleware/pipeline configuration examples, decision framework, and error preservation documentation.

### AC Verification

| Criterion | Evidence |
|-----------|----------|
| AC1: Page exists with correct title | `log-sampling-rate-limiting.md:1` - H1 matches spec |
| AC2: Sampling explained | `log-sampling-rate-limiting.md:16-83` - Middleware + pipeline config |
| AC3: Rate limiting explained | `log-sampling-rate-limiting.md:85-167` - Token bucket with examples |
| AC4: Decision framework | `log-sampling-rate-limiting.md:169-176` - Table matches spec |
| AC5: Error preservation | `log-sampling-rate-limiting.md:207-248` - Errors bypass sampling |

### Quality Gates

- [x] Code examples verified working
- [x] Under 1000 words (973)
- [x] Keywords in H1 and first paragraph
- [x] Added to cookbook index
