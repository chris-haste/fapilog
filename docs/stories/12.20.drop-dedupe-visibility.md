...
- [x] Settings added
- [x] Drop summary implemented
- [x] Dedupe summary implemented
- [x] Internal marker added
...
Reviewed implementation of optional drop/dedupe visibility feature. Settings, builder method, emission logic, and documentation all complete.

### AC Verification

| Criterion | Evidence |
|-----------|----------|
| AC1: Config option | `settings.py:823-837` - emit_drop_summary field |
| AC2: Drop summary | `logger.py:450-479` - _emit_drop_summary_event |
| AC3: Dedupe summary | `logger.py:515-544` - _emit_dedupe_summary_event |
| AC4: Default disabled | `settings.py:824` - default=False |
| AC5: Rate-limited | `logger.py:420-426` - window check |
| AC6: Documented | `configuration.md:269-305` - full section |
...
- [x] mypy passed
- [x] diff-cover 88% (defensive exception handlers uncovered)
