...
Reviewed preset changes enabling redaction by default in fastapi preset, documentation updates, and test coverage.

### AC Verification

| Criterion | Evidence |
|-----------|----------|
| AC1: FastAPI Preset Enables Redactors | `presets.py:85` - redactors list; `presets.py:90-119` - redactor_config matching production |
| AC2: Sensitive Data Redacted | Config parity with production verified in `test_presets.py:112-119` |
| AC3: URL Credentials Redacted | `presets.py:118` - url_credentials enabled |
| AC4: Documentation Updated | `configuration.md:61,82`; `fastapi.md:135-154` |
| AC5: Backwards Compatibility Note | `CHANGELOG.md:7`; `fastapi.md:143-152` |
