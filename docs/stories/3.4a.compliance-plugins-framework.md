...
- Compliance validation surfaces in marketplace entries
...
### AC5: Marketplace Integration

- [ ] Compliance validation surfaces in marketplace entries
- [ ] Marketplace shows compliance status
- [ ] Filter plugins by compliance standards
...
### Phase 5: Marketplace
- [ ] Add compliance fields to marketplace schema
