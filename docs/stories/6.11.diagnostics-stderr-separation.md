...
- [ ] Change default output from stdout to stderr
- [ ] Add `diagnostics_output` setting
- [ ] Initialize output stream from settings
- [ ] Update CHANGELOG
...
- [ ] Diagnostics write to stderr by default
- [ ] Backward-compatible stdout option exists
- [ ] All tests pass
- [ ] CHANGELOG updated
