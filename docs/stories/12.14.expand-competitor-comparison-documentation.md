...
Choose what happens when the queue fills: configure `wait_ms` and `drop_on_full` to balance latency vs durability.
...
Reviewed new why-fapilog.md landing page and expanded comparisons.md covering structlog, loguru, stdlib, and OpenTelemetry with feature matrices, architecture diagrams, and migration examples.

### AC Verification

| Criterion | Evidence |
|-----------|----------|
| AC1: Expanded Feature Comparison | `comparisons.md:1-257` - 4 competitors, 6 feature tables, legend |
| AC2: "Why Fapilog?" Landing Page | `why-fapilog.md:1-122` - Decision guide, differentiators, trade-offs |
| AC3: Performance Section | `comparisons.md:124-131` - Performance table with benchmarks link |
| AC4: Architecture Comparison | `comparisons.md:76-83,134-182` - Architecture table and diagrams |
| AC5: Prominent Placement | `index.md:60-61` - Top-level toctree, redirect in place |
| AC6: Evaluator Journey | `index.md:17` - Links in first scroll, sidebar access |
| AC7: Accuracy Verification | `comparisons.md:10` - Dated January 2026, claims verified |

### Quality Gates

- [x] Documentation builds without warnings (`sphinx-build -W`)
- [x] Navigation order correct
- [x] All internal links work
- [x] Redirect in place for old location
...
| 2026-01-22 | Implementation complete, code review passed | Claude |
